...
CREATE TABLE users (
  ...
  FOREIGN KEY (default_cohort) REFERENCES cohorts(cohort_name) ON DELETE CASCADE
);

CREATE TABLE cohorts (
  cohort_id SERIAL,
  cohort_name VARCHAR(15) UNIQUE PRIMARY KEY,
  begin_date DATE,
  end_date DATE,
...
INSERT INTO students (name, email, github, cohort_name)
  VALUES
    ('Andy Bernard', 'NardDog@email.com', 'RooDoDooDoDooHub', 'MCSP-17'),
    ('Jim Halpert', 'BookFace@email.com', 'JimothyGit', 'MCSP-17'),
    ('Stanley Hudson', 'DidIStutter@email.com', 'CrosswordHub', 'MCSP-17'),
    ('Phyllis Vance', 'SometimesIKnit@email.com', 'PPCHub', 'MCSP-17'),
    ('Dwight Schrute', 'belsnickel@email.com', 'BearsBeetsBattlestarGitlactica', 'MCSP-17'),
    ('Angela Martin', 'SaveBandit@email.com', 'KittyGitty', 'MCSP-18'),
    ('Oscar Martinez', 'NumberCruncher@email.com', 'AccountinGit', 'MCSP-18'),
    ('Kevin Malone', 'Scrantonicity@email.com', 'CrushingTacosHub', 'MCSP-18'),
    ('Kelly Kapoor', 'TheBusinessBitch@email.com', 'GittingMoreAttention', 'MCSP-19'),
    ('Toby Flenderson', 'CostaRica@email.com', 'ScrantonStranglerHub', 'MCSP-19'),
    ('Holly Flax', 'DunderMifflinaire@email.com', 'NashuaHub', 'MCSP-19'),
    ('Creed Bratton', 'BOBODDY@email.com', 'LaterSkaterHub', 'MCSP-20'),
    ('Meredith Palmer', 'RabidBat@email.com', 'CasualFridayGit', 'MCSP-20'),
    ('Pam Beesly', 'Beesly-Halpert@email.com', 'ArtistGit', 'MCSP-20'),
    ('Erin Hannon', 'PlopsGirl@email.com', 'ThePensHappened', 'MCSP-20');
