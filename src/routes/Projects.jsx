...
const Projects = (props) => {
  ...
  const [currentSelectedProjectName, setCurrentSelectedProjectName] =
    useState("");
          ...
          <div>
            ...
            >
              ...
              {allProjectNames.map((names) => {
                ...
                return (
                  <option key={names.project_id} value={names.project_name}>
                    {names.project_name}
                  </option>
                );
              })}
            ...
            {students.map((student) => (
              <tr key={student.student_id}>
                ...
                <td className="student-average" width={"15%"}>
                  {selectedProject && selectedProject.project_passed
                    ? "Pass"
                    : "Fail"}
                  {/* {<select
