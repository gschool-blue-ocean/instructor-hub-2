...
const Projects = (props) => {
  ...
  const handleSelectProject = (e) => {
    setCurrentSelectedProjectName(e);
    const selectedProject = allProjectNames.find((project) => project.project_name === e);
      ...
      <div id="home-container">
        <div id="projects-container">
            ...
            <div>
              ...
              >
                {allProjectNames.map((names) => (
                  <Dropdown.Item key={names.project_id} eventKey={names.project_name}>
                    {names.project_name}
                  </Dropdown.Item>
                ))}
              </DropdownButton>
          ...
          <div>
                ...
                {students.map((student) => (
                  <tr key={student.student_id}>
                    <td id="student-name" value={students.student_id} onClick={(e) => {}}>
                      <li className="list" key={student.student_id}>
                        <input
                          type="checkbox"
                          value={student.name}
            ...
            <Modal
              id="project-grading-modal"
              size="md"
              centered
              show={showProjectGradingModal}
              onHide={handleCloseProjectGradingModal}
            >
